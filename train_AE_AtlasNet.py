...
from auxiliary.dataset import ShapeNet
...
for epoch in range(opt.nepoch):
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        dist1 ,dist2, dist3, dist4= distChamfer(points.transpose(2, 1).contiguous(), pointsReconstructed)  # loss function
        ...
        print('[%d: %d/%d] train loss:  %f ' % (epoch, i, len_dataset / 7, loss_net.item()))
